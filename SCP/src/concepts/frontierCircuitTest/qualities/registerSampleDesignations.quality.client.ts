...
import type {
  ...
  FrontierCircuitTestDesignation,
} from '../frontierCircuitTest.type';

const SAMPLE_DESIGNATIONS: FrontierCircuitTestDesignation[] = [
  {
    name: 'Pewter Tessera',
...
export const frontierCircuitTestRegisterSampleDesignations = createQualityCard<FrontierCircuitTestClientState>({
