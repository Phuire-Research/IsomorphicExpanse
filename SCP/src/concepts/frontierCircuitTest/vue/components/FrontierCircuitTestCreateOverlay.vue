...
/**
 * FrontierCircuitTestCreateOverlay — the Create S8 STEP PIPELINE (C372 · the Creation Pipeline Overlay)
 *
 ...
 *   STEP 3 · THE PAGE — invokes frontierCircuitTest_page_create on the bridge via the controller's awaitable
 *                       triggerFrontierCircuitTestPageCreate (the SAME /mcp tools/call idiom the GitM buttons ride,
 ...
 *
 * Citation: FrontierCircuitTestBiplane.vue requestTurnOverToB (:250 — the writeGitmTurnoverProgress + hard turn-over).
 * Citation: GitmSwordBButton.vue triggerGitmAction/triggerGitmMean (the /mcp tools/call idiom).
 * Citation: scsBridgeController triggerFrontierCircuitTestPageCreate (the awaitable page-create result-parsing mean).
...
// The PascalCase concept name for frontierCircuitTest_page_create's `name` arg — the minted name with spaces
...
// ============================================================
// STEP 3 · THE PAGE (frontierCircuitTest_page_create · the awaitable controller mean · the ~30s window).
// ============================================================
...
async function runPageCreate() {
  ...
  try {
    ...
    const res = await ctrl.triggerFrontierCircuitTestPageCreate({
