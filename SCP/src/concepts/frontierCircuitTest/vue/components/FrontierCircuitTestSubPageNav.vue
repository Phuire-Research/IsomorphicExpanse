...
/**
 * FrontierCircuitTest Sub-Page Navigation (Band A-6 HCD)
 *
 ...
 * click; the parent dispatches the Stratimux Quality (frontierCircuitTestSetActiveSubPage).
 *
 ...
 * Citation: frontierCircuitTest.subPageRegistry.ts (FRONTIERCIRCUITTEST_SUB_PAGE_OPTIONS source).
 */
import type { FrontierCircuitTestSubPage } from '../../frontierCircuitTest.type';
import type { FrontierCircuitTestSubPageOption } from '../../frontierCircuitTest.subPageRegistry';

interface Props {
  options: FrontierCircuitTestSubPageOption[];
...
const emit = defineEmits<{
  (event: 'subPageSelected', value: FrontierCircuitTestSubPage): void;
}>();

function handleClick(option: FrontierCircuitTestSubPageOption) {
...
<template>
  <nav class="frontierCircuitTest-subpage-nav hifi-pane-base">
...
<style scoped>
.frontierCircuitTest-subpage-nav {
