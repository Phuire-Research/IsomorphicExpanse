...
import type {
  ...
  IsomorphicExpanseDesignation,
} from '../isomorphicExpanse.type';

const SAMPLE_DESIGNATIONS: IsomorphicExpanseDesignation[] = [
  {
    name: 'Pewter Tessera',
...
export const isomorphicExpanseRegisterSampleDesignations = createQualityCard<IsomorphicExpanseClientState>({
